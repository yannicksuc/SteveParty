 ...
 * on the face a paint was sprayed on. The block itself is in the chunk mesh (see the stencil sign models).
 * <p>
 * Painted symbols take the dye's sign colour; engraved ones are a dark, see-through print of the shape.
 */

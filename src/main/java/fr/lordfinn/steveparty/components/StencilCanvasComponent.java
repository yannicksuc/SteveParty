 ...
 */
public record StencilCanvasComponent(List<Byte> shape, Optional<DyeColor> color, boolean glowing) {
    ...
    public static StencilCanvasComponent of(byte[] shape, @Nullable DyeColor color, boolean glowing) {
        return new StencilCanvasComponent(StencilShape.toList(shape), Optional.ofNullable(color), glowing);
    }
